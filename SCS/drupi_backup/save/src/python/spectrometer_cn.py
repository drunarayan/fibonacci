...
def wavelengthToColor(lambda2):
    ...
    #thresholds =  [ 380, 400, 450, 465, 520, 565, 780, 850 ];
    ...
    elif (lambda2 >= 600 and lambda2 < 850):
        factor = 0.2 + 0.8*(850 - lambda2)  //  (850 - 600);
...
if func == "take":
	...
	print("calling scanline ...")
	drawScanLine(aperture,spectrumAngle,draw)
	print("ending scanline ...")
	...
	print ("ideal exposure between 0.15 i 0.30")
	print (("exposure="),exposure)
	if (exposure<0.15):
		print ("consider increasing shuttertime")
	elif (exposure>0.3):
		print ("consider decreasing shuttertime")
	else:
		print("good exposure",exposure)
	...
	print("saved _pngfile ...")
	
else:
	print("wrong parameter for step")
